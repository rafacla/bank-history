...
urlpatterns = [
    ...
    path('transactions/delete/<str:ids>/', views.TransactionDeleteView.as_view(), name='transaction_delete'),
    ...
    path('rules/delete/<str:ids>/', views.RuleDeleteView.as_view(), name='rule_delete'),
